...
template <int group, typename number_t, typename instance_t>
boolean::cover import_cover(const parse_expression::assignment_t<group, number_t, instance_t> &syntax, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	return boolean::cover(import_cube(syntax, nets, default_id, tokens, auto_define));
}

template <int group, typename number_t, typename instance_t>
boolean::cube import_cube(const parse_expression::composition_t<group, number_t, instance_t> &syntax, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	if (syntax.region != "") {
...
template <int group, typename number_t, typename instance_t>
boolean::cover import_cover(const parse_expression::composition_t<group, number_t, instance_t> &syntax, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	if (syntax.region != "") {
		default_id = atoi(syntax.region.c_str());
	}
...
template <int group, typename number_t, typename instance_t>
boolean::cover import_argument(const parse_expression::expression_t<group, number_t, instance_t> &syntax, const parse_expression::argument_t<group, number_t, instance_t> &arg, bool isCover, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	if (arg.sub.valid) {
...
template <int group, typename number_t, typename instance_t>
boolean::cube import_cube(const parse_expression::expression_t<group, number_t, instance_t> &syntax, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	if (syntax.level >= (int)syntax.precedence.size()) {
		if (tokens != nullptr) {
			tokens->load(&syntax);
			tokens->error("unrecognized operation", __FILE__, __LINE__);
...
template <int group, typename number_t, typename instance_t>
boolean::cover import_cover(const parse_expression::expression_t<group, number_t, instance_t> &syntax, ucs::Netlist nets, int default_id, tokenizer *tokens, bool auto_define) {
	if (syntax.level >= (int)syntax.precedence.size()) {
		if (tokens != nullptr) {
			tokens->load(&syntax);
			tokens->error("unrecognized operation", __FILE__, __LINE__);
