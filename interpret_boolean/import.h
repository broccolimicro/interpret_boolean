...
int import_variable(tokenizer &tokens, const parse_boolean::variable_name &syntax, boolean::variable_set &variables, bool define = false, bool squash_errors = false);
boolean::cube import_cube(tokenizer &tokens, const parse_boolean::variable_name &syntax, boolean::variable_set &variables, bool define = false, bool squash_errors = false);
boolean::cover import_cover(tokenizer &tokens, const parse_boolean::variable_name &syntax, boolean::variable_set &variables, bool define = false, bool squash_errors = false);
...
boolean::cover import_cover(tokenizer &tokens, const parse_boolean::guard &syntax, boolean::variable_set &variables, bool auto_define = false);
